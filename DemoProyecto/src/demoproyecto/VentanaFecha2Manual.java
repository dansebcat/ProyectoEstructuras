 ...
 * @author ferna
 */
public class VentanaFecha2Manual extends javax.swing.JFrame {

    /**
     * Creates new form VentanaFecha2Manual
     */
    public VentanaFecha2Manual() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAvanzarFecha2.setText("AVANZAR A FECHA 3");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaFecha2Manual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaFecha2Manual().setVisible(true);
            }
        });
    }
