 ...
 * @author ferna
 */
public class VentanaFecha3Manual extends javax.swing.JFrame {

    /**
     * Creates new form VentanaFecha2Manual
     */
    public VentanaFecha3Manual() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(923, 580));
        setResizable(false);
        setSize(new java.awt.Dimension(923, 580));
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
        VentanaFecha2Manual regresar = new VentanaFecha2Manual();
    ...
    VentanaOctavos avanzar = new VentanaOctavos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaFecha3Manual.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaFecha3Manual().setVisible(true);
            }
        });
    }
